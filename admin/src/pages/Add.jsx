  ...
  return (
    <form className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={descriptions} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write content here' required/>
      </div>
