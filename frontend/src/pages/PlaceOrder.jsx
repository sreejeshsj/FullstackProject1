...
function PlaceOrder() {
  ...
  const {navigate,backendUrl,token,cartItems,setCartItems,getTotalPrice,delivery_fee,products}=useContext(ShopContext)
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
         ...
         <input onChange={onChangeHandler}  name='phone' value={formData.phone} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="mobile" placeholder='phone' required/>
      </div>
      {/*---------------------------Right side-------------------------------*/}
      <div className='mt-8'>
